        ...
        for (int i = 1; i <= quantidadeDeFases; i++) {
            ...
            for (Monstro monstro : monstrosDaFase) {
                if (dificuldade == com.rpg.core.Dificuldade.DIFICIL) {
                    // Exemplo: Monstros em dificuldade DIFICIL podem ter uma chance maior de dropar itens específicos
                    // ou ter itens adicionais em sua lista de drops.
                    // Por simplicidade, vamos apenas garantir que eles tenham mais opções de armas.
                    // A lógica de drop real está em Monstro.java
                }
            }
